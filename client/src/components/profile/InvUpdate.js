...
//                                   <button onClick={updateInv}>Update</button>
//                               </div>
//                           </div>
//                           <div className="row">
//                               <div className="col-md-6 profile-sub-headers">
...
//                                           </div>
//                                           <div className="col-md-6">
//                                               <input>{invAdd.InvestorStreet}</input>
//                                           </div>
//                                       </div>
//                                       <div className="row">
//                                           <div className="col-md-6">
...
//                                           </div>
//                                           <div className="col-md-6">
//                                               <input>{invAdd.InvestorCity}</input>
//                                           </div>
//                                       </div>
//                                       <div className="row">
//                                           <div className="col-md-6">
...
//                                           </div>
//                                           <div className="col-md-6">
//                                               <input>{invAdd.InvestorPoBox}</input>
//                                           </div>
//                                       </div>
//                                       <div className="row">
//                                           <div className="col-md-6">
...
//                                           </div>
//                                           <div className="col-md-6">
//                                               <input>{invAdd.InvestorPostalCode}</input>
//                                           </div>
//                                       </div>
//                                       <div className="row">
//                                           <div className="col-md-6">
...
//                                           </div>
//                                           <div className="col-md-6">
//                                               <input>{invAdd.InvestorCounty}</input>
//                                           </div>
//                                       </div>
//                                   </div>
//                               </div>
